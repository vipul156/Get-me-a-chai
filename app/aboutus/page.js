    ...
    <div className="container mx-auto px-8 md:px-4 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/fans.png" alt="Fans Want to Collaborate" />
                    <div>
                ...
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/funding.png" alt="Support Through Chai" />
                    <div>
